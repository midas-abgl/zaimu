...
- [ ] Criar esquema, migração e domínio do livro de dívidas.
- [ ] Implementar APIs, convites, projeções bilaterais e integrações financeiras.
...
Criar modelos relacionais e migração preservando dívidas existentes.
