-- AlterTable
ALTER TABLE "public"."PortfolioStock" ADD COLUMN "groupId" varchar(24),
ADD COLUMN "meanPrice" decimal(5,2),
ADD COLUMN "quantity" decimal(5,2),
...
-- CreateTable
CREATE TABLE "public"."PortfolioStockGroup" (
    "id" varchar(24) NOT NULL DEFAULT cuid2(),
    "portfolioId" UUID NOT NULL,
    "allocation" decimal(5,2) NOT NULL DEFAULT 0,

    CONSTRAINT "PortfolioStockGroup_pkey" PRIMARY KEY ("id")
);

-- AddForeignKey
ALTER TABLE "public"."PortfolioStock" ADD CONSTRAINT "PortfolioStock_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "public"."PortfolioStockGroup"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."PortfolioStockGroup" ADD CONSTRAINT "PortfolioStockGroup_portfolioId_fkey" FOREIGN KEY ("portfolioId") REFERENCES "public"."Portfolio"("id") ON DELETE CASCADE ON UPDATE CASCADE;